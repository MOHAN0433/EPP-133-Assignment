  ...
  try {
    ...
    await dynamoDB
      .putItem({
        ...
        Item: {
          educationId: { N: event.body.educationId },
          filename: { S: filename }, // Assuming filename is of type String
          createdAt: { N: String(Date.now()) }, // Optionally, you can include a createdAt timestamp
        },
      })
      .promise();
